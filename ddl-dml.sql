...
INSERT INTO problem VALUES (31, 'Viet chuong trinh lay so nguyen n tu nguoi dung va hien thi tong cac so tu 1 den n tren man hinh. \n\nVi du, neu n = 5, chuong trinh se cho ket qua nhu sau: 1 + 2 + 3 + 4 + 5 = 15', '5', '15', '7', '28');
INSERT INTO problem VALUES (32, 'Viet chuong trinh nhan hai so nguyen a va b tu nguoi dung va hien thi tong cac so le giua a va b tren man hinh (b > a).\n\nVi du, neu a = 3, b = 9, dau ra phai la: 3 + 5 + 7 + 9 = 24', '3,9', '24', '16,24', '80');
INSERT INTO problem VALUES (33, 'Viet chuong trinh lay mot chuoi s tu ban phim va hien thi cac ky tu khong phai la "y" trong chuoi s tren man hinh.\n\nVi du: neu s = "mysql", ket qua dau ra phai la:\n\nCurrent character: m\nCurrent character: s\nCurrent character: q\nCurrent character: l', 'sunny', 'Current character: s\nCurrent character: u\nCurrent character: n\nCurrent character: n', 'lyly', 'Current character: l\nCurrent character: l');
INSERT INTO problem VALUES (34, 'Viet chuong trinh lay mot so nguyen a tu ban phim va hien thi cac tich cua a va cac so tu 1 den 5 tren man hinh.\n\nVi du: neu a = 10, chuong trinh se cho ket qua nhu sau:\n\n10 * 1 = 10\n10 * 2 = 20\n10 * 3 = 30\n10 * 4 = 40\n10 * 5 = 50', '5', '5 * 1 = 5\n5 * 2 = 10\n5 * 3 = 15\n5 * 4 = 20\n5 * 5 = 25', '6', '6 * 1 = 6\n6 * 2 = 12\n6 * 3 = 18\n6 * 4 = 24\n6 * 5 = 30');
INSERT INTO problem VALUES (35, 'Viet chuong trinh lay hai so nguyen a va b tu nguoi dung va hien thi thong tin sau tren man hinh:\n\nNumber of even numbers: {P1}\nNumber of odd numbers: {P2}\n\nTrong do {P1} la so cac so chan va {P2} la so cac so le trong pham vi [a, b].\n\nVi du, neu a = 1, b = 10, chuong trinh se cho ket qua nhu sau:\n\nNumber of even numbers: 5\nNumber of odd numbers: 5', '14,23', 'Number of even numbers: 5\nNumber of odd numbers: 5', '30,40', 'Number of even numbers: 6\nNumber of odd numbers: 5');
